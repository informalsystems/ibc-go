...
type QueryTotalRecvFeesResponse struct {
	...
	RecvFees []types1.Coin `protobuf:"bytes,1,rep,name=recv_fees,json=recvFees,proto3" json:"recv_fees" yaml:"recv_fees"`
}
...
func (m *QueryTotalRecvFeesResponse) GetRecvFees() []types1.Coin {
	if m != nil {
		return m.RecvFees
	}
	return nil
...
type QueryTotalAckFeesResponse struct {
	...
	AckFees []types1.Coin `protobuf:"bytes,1,rep,name=ack_fees,json=ackFees,proto3" json:"ack_fees" yaml:"ack_fees"`
}
...
func (m *QueryTotalAckFeesResponse) GetAckFees() []types1.Coin {
	if m != nil {
		return m.AckFees
	}
	return nil
...
type QueryTotalTimeoutFeesResponse struct {
	...
	TimeoutFees []types1.Coin `protobuf:"bytes,1,rep,name=timeout_fees,json=timeoutFees,proto3" json:"timeout_fees" yaml:"timeout_fees"`
}
...
func (m *QueryTotalTimeoutFeesResponse) GetTimeoutFees() []types1.Coin {
	if m != nil {
