...
type Fee struct {
	...
	RecvFee []types.Coin `protobuf:"bytes,1,rep,name=recv_fee,json=recvFee,proto3" json:"recv_fee" yaml:"recv_fee"`
	// the packet acknowledgement fee
	AckFee []types.Coin `protobuf:"bytes,2,rep,name=ack_fee,json=ackFee,proto3" json:"ack_fee" yaml:"ack_fee"`
	// the packet timeout fee
	TimeoutFee []types.Coin `protobuf:"bytes,3,rep,name=timeout_fee,json=timeoutFee,proto3" json:"timeout_fee" yaml:"timeout_fee"`
}
...
func (m *Fee) GetRecvFee() []types.Coin {
	if m != nil {
		return m.RecvFee
	}
	return nil
